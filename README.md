...
In order to switch to branch *b4.1.2-beta* you can use the following command:
```
$ git checkout -b b4.1.2-beta origin/b4.1.2-beta*
```


## Tags

Also there are tags which usually are originated from a release branch. For instance, tag *b4.1.2-beta* will be originated from branch *b4.1.1*.
...
For instance, to checkout *b4.1.2-beta* you can enter the following command:
```
$ git checkout -b b4.1.2-beta b4.1.2-beta
```
